...
\newcommand{\drawSimpleSaxDiagram}[0]{%
    \begin{tikzpicture}
      % Palm keys (green)
      \coordinate (palmKeys) at (231pt,50pt);
      ...
      \draw [fill=blue] (mainKeys)       circle[radius=2.268pt]
               ...
               +(1.02pt,-4.34pt)  circle[radius=1.70pt,fill=blue]
             ++(0,-9.18pt)        circle[radius=2.268pt,fill=red]
             ++(0,-5.10pt)        circle[radius=2.268pt,fill=blue];
      ...
      \coordinate (auxKeys) at (221.55pt,38pt);
      ...
      \coordinate (lowClusterKeys) at (221.55pt,18pt);
