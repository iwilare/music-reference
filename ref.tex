...
\newcommand{\sectorNodeDefault}[4]{%
  ...
  \ifsaxKeys
    \node[anchor=base, rotate=#2-\counterrotation, shift={(0,-\staffStep)}] at (#2:{\saxnotesdistance+2*\rotatedsheetdistance+#4}) {
      \begin{tikzpicture}
        \foreach \x in {58,...,78} {
          \pgfmathsetmacro{\val}{#1+\x}%
          \node at (18pt*\x, 0pt) {\saxFingering{\val}};
          %\node at (18pt*\x-3pt,      -34pt) {\saxNoteName{\val}};
        }
      \end{tikzpicture}
    }
  \fi
