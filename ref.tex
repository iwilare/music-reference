...
\newcommand{\drawSimpleSaxDiagram}[0]{%
    \begin{tikzpicture}[x=12cm,y=1.8cm]
      % Palm keys (green)
      \coordinate (palmKeys) at (0.6825,0.84);
      \draw [fill=green] (palmKeys) ellipse (0.03cm and 0.13cm);
      \draw [fill=green] ($(palmKeys)+(0.005,0.10)$) ellipse (0.03cm and 0.13cm);
      \draw [fill=green] ($(palmKeys)+(0.01,0.05)$) ellipse (0.03cm and 0.13cm);

      % Main finger keys (blue)
      \coordinate (mainKeys) at (0.67,0.995);
      \draw [fill=blue] (mainKeys) ellipse (0.04cm and 0.09cm);
      \draw [fill=blue] ($(mainKeys)+(0,-0.105)$) circle[radius=0.08cm];
      \draw [fill=blue] ($(mainKeys)+(0.003,-0.19)$) circle[radius=0.06cm];
      \draw [fill=blue] ($(mainKeys)+(0,-0.305)$) circle[radius=0.08cm];
      \draw [fill=blue] ($(mainKeys)+(0,-0.405)$) circle[radius=0.08cm];

      % Side keys (yellow)
      \coordinate (sideKeys) at (0.69,0.59);
      \draw [fill=yellow] (sideKeys) ellipse (0.1cm and 0.03cm);
      \draw [fill=yellow,rounded corners=0.025cm] ($(sideKeys)+(-0.007, -0.06)$) rectangle ($(sideKeys)+(-0.002, -0.02)$);
      \draw [fill=yellow,rounded corners=0.025cm] ($(sideKeys)+(0.000, -0.06)$) rectangle ($(sideKeys)+(0.005, -0.02)$);
      \draw [fill=yellow] ($(sideKeys)+(0, -0.08)$) ellipse (0.1cm and 0.03cm);

      % Thumb hook (single line, not grouped)
      \draw[] (0.635,0.59) -- ++(0.07,-0.2);

      % Auxiliary keys (green rectangles)
      \coordinate (auxKeys) at (0.6425,0.38);
      \draw [fill=green,rounded corners=0.025cm] (auxKeys) rectangle ($(auxKeys)+(0.005,0.05)$);
      \draw [fill=green,rounded corners=0.025cm] ($(auxKeys)+(0, -0.07)$) rectangle ($(auxKeys)+(0.005, -0.02)$);
      \draw [fill=green,rounded corners=0.025cm] ($(auxKeys)+(0, -0.14)$) rectangle ($(auxKeys)+(0.005, -0.09)$);

      % Lower stack keys (cyan circles)
      \coordinate (lowerStackKeys) at (0.67,0.39);
      \draw [fill=cyan] (lowerStackKeys) circle[radius=0.08cm];
      \draw [fill=cyan] ($(lowerStackKeys)+(0, -0.10)$) circle[radius=0.08cm];
      \draw [fill=cyan] ($(lowerStackKeys)+(0, -0.20)$) circle[radius=0.08cm];

      % Low C/Eb cluster (gray)
      \coordinate (lowClusterKeys) at (0.65,0.19);
      \draw [fill=gray] (lowClusterKeys) ellipse (0.1cm and 0.05cm);
      \draw [fill=gray,rounded corners=0.025cm] ($(lowClusterKeys)+(0.005,0.05)$) rectangle ($(lowClusterKeys)+(0.01,0.15)$);

      % Pinky keys (red)
      \coordinate (pinkyKeys) at (0.67,0.10);
      ...
      % \draw [fill=red]
      %   ($(pinkyKeys)-(0.01,-0.025)-(0,0.06)$)
      %     arc[start angle=180, end angle=360, radius=0.01cm] --
      %   ($(pinkyKeys)+(0.01,-0.025)-(0,0.06)$)
      %     arc[start angle=0, end angle=180, radius=0.01cm] -- cycle;
    \end{tikzpicture}
}
