...
\newcommand{\drawSimpleSaxDiagram}[0]{%
    \begin{tikzpicture}
      ...
      % Palm keys (green)
      \node (PalmD) at (231pt,50pt) [draw, ellipse, minimum width=0.06cm, minimum height=0.26cm, fill=green] {};
      \node (PalmDsharp) at ($(PalmD)+(1.7pt,5.1pt)$) [draw, ellipse, minimum width=0.06cm, minimum height=0.26cm, fill=green] {};
      \node (PalmF) at ($(PalmD)+(3.7pt,2.6pt)$) [draw, ellipse, minimum width=0.06cm, minimum height=0.26cm, fill=green] {};

      % Main finger keys (blue)
      \node (FrontF) at ($(227pt,52.2pt)$) [draw, ellipse, minimum height=0.09cm, minimum width=0.17cm, fill=blue] {};

      \node (B) at (227pt,48.2pt) [draw, circle, minimum size=4.1pt, xshift=-0.3pt, fill=red] {};
      \node (Bbis) at ($(B)+(1.02pt,-3.3pt)$) [draw, circle, minimum size=2.4pt, fill=blue] {};
      \node (A) at ($(227pt,50pt)+(0,-9.18pt)$) [draw, circle, minimum size=4.536pt, fill=red] {};
      \node (G) at ($(A)+(0,-5.10pt)$) [draw, circle, minimum size=4.536pt, fill=blue] {};

      % Side keys (yellow)
      \node (Gsharp) at (233pt,38pt) [draw, shape=semicircle, rotate=0, minimum width=0.15cm, fill=yellow] {};
      \node (LowB) at ($(Gsharp)+(0pt,-0.85pt)$) [draw, rectangle, rounded corners=0.025cm, minimum width=2.3pt, minimum height=1.7pt, fill=yellow,anchor=north east] {};
      \node (LowCsharp) at ($(Gsharp)+(0pt,-0.85pt)$) [draw, rectangle, rounded corners=0.025cm, minimum width=2.3pt, minimum height=1.7pt, fill=yellow, anchor=north west] {};
      \node (LowBflat) at ($(Gsharp)+(0pt,-4.0pt)$) [draw, shape=semicircle, rotate=180, minimum width=0.15cm, fill=yellow] {};

      \draw[] [xshift=-3](227pt,31.8pt) -- ++(6pt,0pt);

      % Auxiliary keys (green rectangles)
      \node (AuxFsharp) at (221.55pt,38pt) [draw, rectangle, rounded corners=0.025cm, minimum width=1.7pt, minimum height=4.1pt, fill=green] {};
      \node (AuxC) at ($(AuxFsharp)+(0pt,-4.5pt)$) [draw, rectangle, rounded corners=0.025cm, minimum width=1.7pt, minimum height=4.1pt, fill=green] {};
      \node (AuxEb) at ($(AuxC)+(0pt,-4.5pt)$) [draw, rectangle, rounded corners=0.025cm, minimum width=1.7pt, minimum height=4.1pt, fill=green] {};

      % Lower stack keys (cyan circles)
      \node (F) at (227pt,28pt) [draw, circle, minimum size=4.536pt, fill=cyan] {};
      \node (E) at ($(F)+(0pt,-5.10pt)$) [draw, circle, minimum size=4.536pt, fill=cyan] {};
      \node (D) at ($(E)+(0pt,-5.10pt)$) [draw, circle, minimum size=4.536pt, fill=cyan] {};

      % Pinky keys (red)
      \node (Dsharp) at ($(D)+(0pt,-5.1pt)$) [draw, fill=red, shape=semicircle, rotate=0, minimum width=5pt, minimum height=2.5pt] {};
      \node (C) at ($(Dsharp)+(0pt,-2.7pt)$) [draw, fill=red, shape=semicircle, rotate=180, minimum width=5pt, minimum height=2.5pt] {};

      % Low C/Eb cluster (gray)
      \node (HighFsharp) at (221.55pt,21pt) [draw, rectangle, rounded corners=0.025cm, minimum width=2pt, minimum height=4.5pt, fill=gray] {};
      \node (SideFsharp) at ($(HighFsharp)+(0pt,-6pt)$) [draw, ellipse, minimum width=0.1cm, minimum height=0.16cm, fill=gray] {};
      \end{scope}
    \end{tikzpicture}
}
