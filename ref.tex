...
\newcommand{\sectorNodeDefault}[4]{%
  ...
  \ifrotateKeySignatures
    \node[font=\bfseries\large, inner sep=-1.8pt, rotate=#2] (main) at (#2:#3) {\note};
    \node[font=\scriptsize, anchor=north, rotate=#2, text=white!30!black] at (main.south) {\saxnote};
  \else
  ...
  \ifrotateKeySignatures
    \node[anchor=base, rotate=#2, shift={(0,-\staffStep)}] at (#2:{\rotatedsheetdistance+#4}) {\drawKeySignature{\pc}};
  \else
...
\newcommand{\innerSectorNoteMinor}[4]{%
  ...
  \ifrotateKeySignatures
    \node[font=\bfseries\large, inner sep=-1.8pt, rotate=#2] at (#2:#3) {\small \note m};
  \else
